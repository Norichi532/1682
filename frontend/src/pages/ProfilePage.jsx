      ...
      <div className="bg-navy py-10 px-4">
        <div className="max-w-4xl mx-auto flex items-center justify-between gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-full bg-ochre/20 border-2 border-ochre/40 flex items-center justify-center text-white font-display text-2xl font-bold flex-shrink-0">
